...
echo 22) Optional Feature Random battle
start /b "kienboec battle" curl -X POST http://localhost:10001/randombattles --header "Authorization: Basic kienboec-mtcgToken"
start /b "altenhof battle" curl -X POST http://localhost:10001/randombattles --header "Authorization: Basic altenhof-mtcgToken"
ping localhost -n 10 >NUL 2>NUL
